...
simulationproject for interview process
...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so simulation_interview can be imported
    ├── src                <- Source code for use in this project.
    │   ├── simulation_interview <- Main package folder
    │   │   └── __init__.py    <- Marks as package
    │   │   └── simulation_interview.py  <- Just some placeholder Python source code file
    │
